...
![FlowWatch 浅色模式](docs/screenshots/screenshot-light-v8.png)

暗色模式：

![FlowWatch 暗色模式](docs/screenshots/screenshot-dark-v8.png)
...
![FlowWatch light mode](docs/screenshots/screenshot-light-v8.png)

Dark mode:

![FlowWatch dark mode](docs/screenshots/screenshot-dark-v8.png)
